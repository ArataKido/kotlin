...
fun Route.deliveryOrderPriceRoutes() {
    ...
    get("/api/v1/delivery-order-price") {
        ...
        val cartValue =
            call.parameters["cart_value"]?.toIntOrNull() ?: throw IllegalArgumentException("Invalid cart_value")
        val userLat =
            call.parameters["user_lat"]?.toDoubleOrNull() ?: throw IllegalArgumentException("Invalid user_lat")
        val userLon =
            call.parameters["user_lon"]?.toDoubleOrNull() ?: throw IllegalArgumentException("Invalid user_lon")
